(function() {
    ...
    <div id="announcement-modal" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.7); z-index: 10000; display: flex; align-items: center; justify-content: center; font-family: 'HYWenHei-85W', 'Microsoft YaHei', sans-serif;">
        <div style="background: white; padding: 20px; border-radius: 12px; max-width: 500px; width: 90%; max-height: 90vh; box-shadow: 0 10px 25px rgba(0,0,0,0.3); text-align: center; display: flex; flex-direction: column;">
            <div style="overflow-y: auto; padding-right: 5px; flex: 1;">
                <img src="https://upload-bbs.miyoushe.com/upload/2026/04/29/284249424/78fbfaf7dfebc699f5a9be512c913b01_7113171029092348133.png" alt="announcement" style="max-width: 100%; height: auto; border-radius: 8px; margin-bottom: 20px;">
            ...
            <button id="close-announcement" style="background: #3498db; color: white; border: none; padding: 10px 25px; border-radius: 6px; cursor: pointer; font-size: 16px; transition: background 0.3s; margin-top: 15px; flex-shrink: 0;">懂你意思！</button>
        </div>
    </div>
    `;
